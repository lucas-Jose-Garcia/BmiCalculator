...
export function Card({text, activate}: Props) {
    const colorVariantes = {
        'active': 'text-slate-800',
        'disabled': 'text-zinc-400'
    }
    return (
        <TouchableOpacity className={`${activate ? 'bg-zinc-100' : 'bg-zinc-300'} w-[150px] h-[110px] flex-row items-center justify-center p-4 shadow rounded-2xl`}>
